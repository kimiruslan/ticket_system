...
$stats_query = "SELECT status, COUNT(*) as count FROM tickets GROUP BY status";
...
$assigned_tickets_stmt = $conn->prepare("
    ...
    LIMIT 10
");
$assigned_tickets_stmt->bind_param("i", $technician_id);
...
$recent_tickets_stmt = $conn->query("
    SELECT t.*, d.serial_number, d.device_type, d.customer_name, tech.name as assigned_technician_name
    FROM tickets t
    LEFT JOIN devices d ON t.device_id = d.id
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-lg font-medium text-gray-900"><?php echo $stats['assigned']; ?></dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-lg font-medium text-gray-900"><?php echo $stats['in_progress']; ?></dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="bg-white overflow-hidden shadow rounded-lg">
                        <div class="p-5">
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        <dt class="text-sm font-medium text-gray-500 truncate">Parts Needed</dt>
                                        <dd class="text-lg font-medium text-gray-900"><?php echo $stats['parts_needed']; ?></dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <?php foreach ($assigned_tickets as $ticket): ?>
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <?php echo htmlspecialchars($ticket['device_type']); ?> (<?php echo htmlspecialchars($ticket['serial_number']); ?>)
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                                    <?php 
                                                    echo $ticket['status'] == 'pending' ? 'bg-yellow-100 text-yellow-800' : 
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                <a href="view_ticket.php?id=<?php echo $ticket['id']; ?>" class="text-indigo-600 hover:text-indigo-900">View</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                                ...
                                <?php else: ?>
                                    <?php foreach ($recent_tickets as $ticket): ?>
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                <?php echo $ticket['assigned_technician_name'] ? htmlspecialchars($ticket['assigned_technician_name']) : 'Unassigned'; ?>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full 
                                                    <?php 
